...
export default async (network : EthNetwork, privateKey:string, alchemyApiKey:string, contractAddress:string, blueprint:string ): Promise<void> => {
  try {
    console.log("mints create",privateKey,alchemyApiKey, network)

...
export default async (network:EthNetwork,privateKey:string ,alchemyApiKey:string, contractAddress:string,name:string,ownerPublicKey:string, projectId:number ) : Promise<void> => {
  try {
